...
interface NavigationController {
    ...
    fun pushFragment(
        ...
        tag: String? = null, animate: Boolean = true,
        viewId: Int = 0, singleton: Boolean = false,
        parentTag: String? = null
    )

    fun pushFragment(
        clazz: KClass<out Fragment>, bundle: Bundle? = null,
        tag: String? = null, animate: Boolean = true, viewId: Int = 0, singleton: Boolean = false
    )
